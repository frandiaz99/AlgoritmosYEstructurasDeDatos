...
public class visitaOsloTest {
    public static void main(String[] args) {
        ...
        ListaGenerica<String> camino = o.paseoEnBici(grafo, "Museo Vikingo", 60, lugaresRestringidos);
        camino.comenzar();
        System.out.println("Camino desde Ayuntamiento a Museo Vikingo con un maximo de 60 minutos: " + camino);
